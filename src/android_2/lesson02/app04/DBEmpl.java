...
public class DBEmpl extends DBSQLite {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String[] deps = getContext().getResources().getStringArray(R.array.dep_items);
	...
	public long addDep(ContentValues values) {
		return this.getWritableDatabase().insert(TableDep.T_NAME, null, values);
	}
	...
	public boolean updateDep(String name, String location, long id) {
		...
		/* Update information */
		return 1 == this.getWritableDatabase().update(TableDep.T_NAME, v, SQL_WHERE_BY_ID, 
